...
- concrete session manager、scheduler lifecycle、event delivery、permission UI/channel wait、prompt assembly、session metadata IO/update orchestration、AI client factory / provider acquisition 仍在 core。
