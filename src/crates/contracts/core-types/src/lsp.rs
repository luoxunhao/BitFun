//! Shared LSP protocol and plugin manifest DTOs.
//!
//! These are wire/data contracts only. Plugin loading, filesystem access, and
//! process lifecycle stay in service/runtime owner crates.
